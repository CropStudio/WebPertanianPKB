<template>
  <q-layout view="hHh lpR fFf">
    ...
    <q-drawer
      ...
      show-if-above
      bordered
      content-class="bg-green-3 text-green-10"
    >
      <q-scroll-area class="fit">
        <q-list padding>
          ...
          <q-item-label class="text-white" header>Data Master</q-item-label>
          <q-item clickable active-class="active" v-ripple to="/pengguna">
            <q-item-section avatar>
              <q-icon name="person" />
            </q-item-section>
          ...
          <q-item active-class="active" clickable v-ripple to="/jatah">
            <q-item-section avatar>
              <q-icon name="store" />
            </q-item-section>
